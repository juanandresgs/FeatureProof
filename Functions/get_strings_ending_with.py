"""
    FeatureProof Middleware function: get_strings_ending_with.py
...
def function_8(substr, min_length=4):
    ...
    return [s for s in fp.get_all_strings(min_length) if s[1].endswith(substr)]
...
def get_function():
    ...
    return {
        8: {
            ...
            'description': 'Retrieve all strings in the binary that end with a specific substring and with a minimum length.',
